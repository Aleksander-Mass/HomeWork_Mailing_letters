...
# то вывести на экран(в консоль) строку: "Невозможно отправить письмо с адреса <sender> на адрес <recipient>".
# Проверка корректности email адресов (наличие "@" и окончание на ".com", ".ru", ".net")
...
send_email('Вы видите это сообщение как лучший студент курса!', 'urban.info@gmail.com', sender='urban.fan@mail.ru')
...
НЕСТАНДАРТНЫЙ ОТПРАВИТЕЛЬ! Письмо отправлено с адреса urban.fan@mail.ru на адрес urban.info@gmail.com
"""
